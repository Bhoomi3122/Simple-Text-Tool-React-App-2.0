// use rfc to get the react component default boiler plate 
...
// isRequired is used to ensure that the parameters are not undefined
Navbar.propTypes = {
  title: PropTypes.string.isRequired
}
// These values will be passed as default if no values are passed manually 
Navbar.defaultProps = {
